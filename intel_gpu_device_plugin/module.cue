...
// opmodel.dev/modules/intel_gpu_device_plugin@v2; this path starts its own
// line), core@v2 identity reshape (complete modulePath with major, identity/
// package, derived fqn), and the version-segment catalog imports
// (resources/v1beta1 etc.).
//
...
import (
	id "jacero.se/modules/intel_gpu_device_plugin/identity"
